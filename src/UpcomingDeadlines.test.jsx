...
describe('Upcoming Deadlines window', () => {
  ...
  it('shows tasks due within the upcoming window', async () => {
    ...
    const courses = [{
      ...
      tasks: [
        { id: 't1', title: 'Today Task', status: 'todo', dueDate: fmt(today), assigneeIds: ['u1'], assigneeId: 'u1', milestoneId: 'm1' },
        { id: 't2', title: 'Future Task', status: 'todo', dueDate: fmt(day14), assigneeIds: ['u1'], assigneeId: 'u1', milestoneId: 'm2' },
        { id: 't4', title: 'Blocked Task', status: 'blocked', dueDate: fmt(day14), assigneeIds: ['u1'], assigneeId: 'u1', milestoneId: 'm2' },
        { id: 't5', title: 'Skip Task', status: 'skip', dueDate: fmt(today), assigneeIds: ['u1'], assigneeId: 'u1', milestoneId: 'm1' },
        { id: 't3', title: 'Outside Task', status: 'todo', dueDate: fmt(day15), assigneeIds: ['u1'], assigneeId: 'u1', milestoneId: 'm1' },
      ],
  ...
  it('prompts for link when completing from deadlines panel', async () => {
    ...
    const courses = [{
      ...
      milestones: [{ id: 'm1', title: 'Milestone 1' }],
      tasks: [
        { id: 't1', title: 'Task', status: 'todo', dueDate: fmt(today), assigneeIds: ['u1'], assigneeId: 'u1', links: [], milestoneId: 'm1' },
      ],
      team: [{ id: 'u1', name: 'Alice', roleType: 'LD' }],
      schedule: {},
    }];
