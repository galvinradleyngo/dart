...
export default function BlockDialog({
  ...
  return (
    <div
      className="fixed inset-0 z-[9999] flex items-center justify-center overflow-y-auto bg-slate-900/60 px-4 py-6 backdrop-blur"
      onClick={() => onCancel?.()}
    >
      <div
        ref={dialogRef}
        ...
        className="w-full max-w-xl glass-surface max-h-[calc(100vh-3rem)] overflow-y-auto p-5 sm:p-6"
