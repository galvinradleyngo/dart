                  ...
                  {milestoneTemplates.length > 0 && (
                    <>
                      ...
                      {selectedMilestoneTemplate && (
                        <button
                          onClick={() => { removeMilestoneTemplate(selectedMilestoneTemplate); setSelectedMilestoneTemplate(""); }}
                          className="inline-flex items-center justify-center rounded-2xl px-3 py-2 text-sm bg-white border border-black/10 shadow-sm hover:bg-slate-50"
                          title="Remove Milestone Template"
                          aria-label="Remove Milestone Template"
                        >
                          <Trash2 size={16} />
                        </button>
                      )}
