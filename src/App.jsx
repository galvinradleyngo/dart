...
function CalendarView({ monthDate, tasks, milestones, team, onPrev, onNext, onToday, schedule }) {
  ...
  return (
    <div className="border border-black/10 rounded-xl overflow-hidden">
      ...
      <div className="grid grid-cols-7 text-xs bg-slate-50 border-b border-black/10">{["Sun","Mon","Mon","Wed","Thu","Fri","Sat"].map((d)=>(<div key={d} className="p-2 text-center font-medium text-slate-700">{d}</div>))}</div>
