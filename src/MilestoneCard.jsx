...
export default function MilestoneCard({
  ...
  return (
    <details className="group rounded-xl border border-black/10 bg-white dark:bg-slate-800 dark:border-white/10">
      <summary className="cursor-pointer select-none p-4 flex items-center justify-between gap-2 list-none [&::-webkit-details-marker]:hidden">
        <div className="flex items-center gap-2 flex-1">
          ...
          <div className="flex-1">
            ...
            <div className="h-2 bg-black/10 dark:bg-white/10 rounded-full mt-2 overflow-hidden">
        ...
        <div className="flex items-center gap-1">
          {onDuplicateMilestone && (
            <button
              ...
              className="inline-flex items-center justify-center w-7 h-7 rounded-full border border-black/10 bg-slate-100 text-slate-600 hover:bg-slate-200 dark:bg-slate-700 dark:border-white/10 dark:text-slate-200 dark:hover:bg-slate-600"
      ...
      <div className="p-4 flex flex-col gap-2">
        {milestone.goal && (
          <p className="text-base text-black/60 dark:text-white/70 mb-2">{milestone.goal}</p>
        )}
